...
gameplayState.prototype.addInventory = function(nameArray){
    ...
    for(i = 0; i < nameArray.length; i++){
        if(i <= 5){
            returnArray.push(new InventoryClass((startingPosX+(198*i)),202,nameArray[i],this,false));
        }else{
            returnArray.push(new InventoryClass((startingPosX+(198*i)),202,nameArray[i],this,true));
        }
